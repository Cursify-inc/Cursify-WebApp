    ...
    return (
        <section className="py-24">
            <Container>
                ...
                <motion.div
                >
                    <div className="mx-auto max-w-6xl rounded-[2rem] bg-brand-dark p-3 shadow-card">
                        <div className="overflow-hidden rounded-[1.55rem] border border-white/10 bg-[#0f1522]">
                            ...
                            <div className="relative isolate grid min-h-[420px] lg:grid-cols-[230px_1fr_310px]">
                                <aside className="relative z-20 border-r border-white/10 bg-white/[0.02] p-5">
                      ...
                      secure-workflow.ts
                        ...
                        <span className="w-6 text-right text-white/20">
                          {index + 1}
                                ...
                                <aside className="relative z-20 border-l border-white/10 bg-white/[0.03] p-5">
                                    <div className="flex items-center gap-2">
                                    ...
                                    <div className="mt-5 space-y-3">
                                        <TinyCard
                                            className="relative w-full"
                                            contentClassName="p-4 text-sm leading-6 text-white/70"
                                        >
                                        ...
                                        {["Subscription active", "Device paired", "License lease valid"].map(
                                            (item) => (
                                                <TinyCard
                                                    key={item}
                                                    className="relative w-full"
                                                    contentClassName="flex items-center gap-2 px-3 py-2 text-sm text-white/70"
                                                >
