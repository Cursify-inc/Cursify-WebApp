...
export const CARD_STYLE = {
    large: "rounded-[1.4rem] card-surface shadow-card border-card-border backdrop-blur-md",
    tiny: "rounded-[1.25rem] card-surface shadow-card-sm border-card-border backdrop-blur-md",
